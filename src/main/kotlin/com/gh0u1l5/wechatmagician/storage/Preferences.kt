...
class Preferences {
    ...
    private var legacy: HashMap<String, Any?>? = null
    ...
    private val receiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            ...
            // New preferences has been moved to the device protected storage.
    ...
    fun load(context: Context?, preferencesName: String) {
        try {
            ...
            if (legacyPrefFile.exists()) {
                // If legacy preferences exists, use the legacy content.
